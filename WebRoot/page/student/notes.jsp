...
<html>
  ...
  <%   String url = "jdbc:mysql://localhost:3306/sc?"
	...
	<tr> 
	<td class="InternalHeader" >公告编号</td>
	<td class="InternalHeader">公告标题</td>
	<td class="InternalHeader" >公告时间</td>
	...
	<div class="layui-form-item">
		    <div class="layui-input-block">
		    	<button class="layui-btn" lay-submit="" lay-filter="changePwd">查看撒</button>
