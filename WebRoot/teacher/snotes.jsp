...
<html>
  ...
  <%   String url = "jdbc:mysql://localhost:3306/sc?"
	...
	<td>
	<form action="../teacher/notesquery.jsp" method="post">
	...
	if(PageNo != 1){
	PrevStart = PageNo - 1;
	out.print("<a href=snotes.jsp?PageNo=1>第一页 </a>: ");
	out.print("<a href=snotes.jsp?PageNo="+PrevStart+">前一页</a>");
	}
	out.print("[");
	//打印需要显示的页码
	...
	out.print("<a href=snotes.jsp?PageNo="+c+">"+c+"</a>");
	}else{
	out.print("<a href=snotes.jsp?PageNo="+c+">"+c+"</a> ,");
	}
	}else{
	...
	NextPage = PageNo + 1;
	out.print("<a href=snotes.jsp?PageNo="+NextPage+">下一页</a>");
	}
	...
	out.print(":");
	out.print("<a href=snotes.jsp?PageNo="+MaxPage+">最后一页</a>");
	}
	out.print("</font>");
	%>
	</div>
