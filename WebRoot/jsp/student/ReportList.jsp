...
<html>
  ...
  <%
	...
	<%
	//获取总记录数
	ResultSet rs = statement.executeQuery("select count(*) from Report_tb where StuNo="+stuno+""); 
	rs.next(); 
	RecordCount = rs.getInt(1); 
		rs = statement.executeQuery("SELECT* FROM Report_tb where StuNo="+stuno+" ORDER BY Time DESC LIMIT "+StartRow+", "+PageSize);
	//获取总页数
...
<blockquote class="layui-elem-quote news_search">
	...
	<td>
	<a class="layui-btn layui-btn-mini links_edit" href='jsp/common/seeReport.jsp?ID=<%=rs.getString("ID")%>'>
