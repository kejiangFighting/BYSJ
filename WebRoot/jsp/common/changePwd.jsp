	...
	<form class="layui-form changePwd" action="changepassword?userID=${currentUser.userID}" method="post">
		<div class="layui-form-item">
		    ...
		    <div class="layui-input-block">
		    	<input type="text" value="${currentUser.userID}" disabled class="layui-input layui-disabled">		    	
		    </div>
		</div>
		<div class="layui-form-item">
		...
		<div class="layui-form-item">
		    <div class="layui-input-block">
		    	<button class="layui-btn" type="submit" lay-submit="" lay-filter="changePwd" name="ChangeAdminPsw">立即修改</button>
