...
%>
  <tr>
    ...
    <td width="120" align="center"><%=tianjiaren %></td>
     ...
     <td ><%=value2 %>
       <a  href="javascript:void(0)" onclick="down1('<%=value1%>','<%=value2%>')" style="font-size: 12px;color: red">下载</a>
     

	<td align="center">
											<a class="layui-btn layui-btn-danger layui-btn-mini links_del" href='jsp/common/del.jsp?id=<%=id %>' onclick="return confirm('真的要删除？')">
