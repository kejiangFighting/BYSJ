...
<body class="childrenBody">
	<blockquote class="layui-elem-quote news_search">
		<form class="layui-form" action="jsp/admin/SearchEquip.jsp" method="post">
		    ...
		    <tbody class="links_content">		   		
						...
						String seach =request.getParameter("search");
							...
							//List<Notice> noticelist=notice.findAll();												
									...
									%>
									<td>
										<a class="layui-btn layui-btn-mini links_edit" href='jsp/admin/updateEquip.jsp?equipID=<%=n.getEquipID()%>'>
												<i class="iconfont icon-edit"></i> 编辑
											</a> 
											<a class="layui-btn layui-btn-danger layui-btn-mini links_del" href='DeleteUserServlet?equipID=<%=n.getEquipID()%>'>
