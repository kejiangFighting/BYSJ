...
<blockquote class="layui-elem-quote news_search">
	...
	<td>
	<a class="layui-btn layui-btn-mini links_edit" href='jsp/admin/updateBook.jsp?bookID=<%=rs.getString("BookID")%>'>
												<i class="iconfont icon-edit"></i> 编辑
											</a> 
											<a class="layui-btn layui-btn-danger layui-btn-mini links_del" href='DeleteUserServlet?bookID=<%=rs.getString("BookID")%>'>
	...
	if(PageNo != 1){
	PrevStart = PageNo - 1;
	out.print("<a href=jsp/admin/BookList.jsp?PageNo=1>第一页 </a>: ");
	out.print("<a href=jsp/admin/BookList.jsp?PageNo="+PrevStart+">前一页</a>");
	}
	out.print("[");
	//打印需要显示的页码
	...
	out.print("<a href=jsp/admin/BookList.jsp?PageNo="+c+">"+c+"</a>");
	}else{
	out.print("<a href=jsp/admin/BookList.jsp?PageNo="+c+">"+c+"</a> ,");
	}
	}else{
	...
	NextPage = PageNo + 1;
	out.print("<a href=jsp/admin/BookList.jsp?PageNo="+NextPage+">下一页</a>");
	}
	...
	out.print(":");
	out.print("<a href=jsp/admin/BookList.jsp?PageNo="+MaxPage+">最后一页</a>");
	}
	out.print("</font>");
	%>
	</div>
