                    ...
                    <div class="row">
                        <div class="col-sm-6 col-sm-offset-3 form-box">
                            ...
                            <div class="form-bottom">
			                    <form role="form" action="cyy1500330201.service/TeaRegisterServlet" method="post" class="layui-form login-form">			                    	
			                        ...
			                        <div class="help">
			                        	<span><a href="Login.jsp">已有账号，直接登录！</a></span>
			                        	<span><a href="StuRegister.jsp">学生注册入口</a></span>
			                        </div>
			                    </form>
		                    </div>
                        </div>                        
